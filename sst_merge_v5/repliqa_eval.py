...
adapter_path = "./FT_model/A7_safety_meta_llama_3.1_8b_instruct_r16_7ep_lr2e-4"  # ファインチューニング済みアダプタのパス
...
output_file = os.path.join(output_dir, f"{adapter_name}_repliqa_eval_results.json")
