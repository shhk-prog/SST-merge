...
merged_model_path = "./merge_model/A5_A7_dare"  # マージ済みモデルのパス
...
output_file = os.path.join(output_dir, f"{model_name}_repliqa_eval_results.json")
...
print("\n" + "="*50)
print("Merge Model Evaluation Results (RepliQA)")
print("="*50)
